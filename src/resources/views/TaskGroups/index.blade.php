        ...
        @if ($taskGroups->isEmpty())
            <ul class="list-group list-group-flush">
                <li class="list-group-item d-flex justify-content-between align-items-center pe-0">
                    <!-- タスクグループ名 -->
                    <div>
                        <a class="btn" href="{{ route('tasks.index.all') }}">すべて</a>
                    </div>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center pe-0">
                    <!-- タスクグループ名 -->
                    <div>
                        <a class="btn" href="{{ route('tasks.index', ['group_id' => 'uncategorized']) }}">未分類</a>
                    </div>
                </li>
            </ul>
        @else
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center pe-0">
                    <!-- タスクグループ名 -->
                    <div>
                        <a class="btn" href="{{ route('tasks.index', ['group_id' => $taskGroup->group_id]) }}">{{ $taskGroup->group_name }}</a>
                    </div>
                    <!-- ドロップダウンメニュー -->
                    <div class="btn-group">
